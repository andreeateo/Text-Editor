...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		System.out.println("NumOfChars\tBasic Time\tEfficient Time");
      ...
      double a = bD.getFleschScore();
		  long finish1 = System.nanoTime();
		  BigDecimal basicTime = BigDecimal.valueOf(((double)(finish1-start1))/1000000000);
		  System.out.print(basicTime + "\t");
			 ...
			 */
			 ...
			 double b = eD.getFleschScore();
			 long finish2 = System.nanoTime();
			 BigDecimal efficientTime = BigDecimal.valueOf(((double)(finish2-start2))/1000000000);
